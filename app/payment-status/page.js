    ...
    content = (
      <div className='bg-white p-6 rounded-lg shadow-lg max-w-md mx-auto'>
        ...
        <p className='text-gray-700 mt-2'>
          ...
          {transactionDetails?.confirmation_code || 'Not available'}
        </p>
        <p className='text-gray-700 mt-2'>
          <strong>Payment Method:</strong>{' '}
          {transactionDetails?.payment_method || 'Not available'}
        </p>
        <button
          onClick={retryPayment}
          className='mt-6 bg-red-600 text-white py-2 px-4 rounded-full w-full hover:bg-red-700 transition duration-300'
        >
          Retry Payment
        </button>
      </div>
